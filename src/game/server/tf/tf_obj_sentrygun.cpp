...
ConVar tf_sentrygun_damage( "tf_sentrygun_damage", "7", FCVAR_CHEAT | FCVAR_NOTIFY);
ConVar tf_sentrygun_ammocheat( "tf_sentrygun_ammocheat", "0", FCVAR_CHEAT | FCVAR_NOTIFY);
ConVar tf_sentrygun_upgrade_per_hit("tf_sentrygun_upgrade_per_hit", "0", FCVAR_CHEAT | FCVAR_NOTIFY);
ConVar tf_sentrygun_newtarget_dist("tf_sentrygun_newtarget_dist", "200", FCVAR_CHEAT | FCVAR_NOTIFY);
